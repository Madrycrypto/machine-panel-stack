...
MACHINE_ID = config.get('Settings', 'machine_id', fallback='BATERFLY')
...
def load_failures():
    default_failures = [
        {"id": 1, "desc": "Brak folii", "severity": "low"},
        {"id": 2, "desc": "Brak kartonów", "severity": "low"},
        {"id": 3, "desc": "Brak kleju", "severity": "medium"},
        {"id": 4, "desc": "Brak palet", "severity": "medium"},
        {"id": 5, "desc": "Brak etykiet", "severity": "low"},
        {"id": 6, "desc": "Inny brak materiału", "severity": "low"},
    ]
...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title(f"Zgłoszenie Braku Materiału - {MACHINE_ID}")
    ...
    def open_admin_panel(self):
        ...
        # Add (+) Button
        ctk.CTkButton(main_frame, text="+ Dodaj nowy brak materiału", command=self.add_admin_failure, fg_color="#1976D2", hover_color="#1565C0").pack(pady=10)
    ...
    def add_admin_failure(self):
        ...
        self.editing_failures.append({"id": new_id, "desc": "Nowy brak", "severity": "low"})
        self.redraw_failure_admin_list()
    ...
    def save_admin_changes(self):
        ...
        self.title(f"Zgłoszenie Braku Materiału - {new_machine_id}")
